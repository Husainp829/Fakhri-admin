...
import type { EventStatsNamaazRow } from "@/containers/events/types";

type EventDashboardNamaazStatsProps = {
  namaazCounts: EventStatsNamaazRow[];
  selectedMarkaz: string;
};

export const EventDashboardNamaazStats = ({
  namaazCounts,
  selectedMarkaz,
}: EventDashboardNamaazStatsProps) => (
