...
import type { CurrentEvent, EventStatsNiyaazRow } from "@/containers/events/types";

type EventDashboardMarkazStatsProps = {
  niyaazCounts: EventStatsNiyaazRow[];
  selectedMarkaz: string;
};

export const EventDashboardMarkazStats = ({
  niyaazCounts,
  selectedMarkaz,
}: EventDashboardMarkazStatsProps) => {
