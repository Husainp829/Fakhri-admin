...
import { FMB_ISO_WEEKDAY_CHOICES } from "@/containers/fmb/fmb-iso-weekday-choices";

const nullIfEmptyNumber = (v: unknown) => (v === "" || v === undefined ? null : v);
...
type ProfileFormProps = Omit<React.ComponentProps<typeof SimpleForm>, "children">;

export function ProfileForm({ toolbar = <ProfileFormToolbar />, ...rest }: ProfileFormProps) {
  return (
