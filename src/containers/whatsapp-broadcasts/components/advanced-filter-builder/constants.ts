export type ItsColumnDef = { id: string; label: string; type: "string" | "number" };

export const ITS_COLUMNS: ItsColumnDef[] = [
...
export const getOperatorsForType = (type: ItsColumnDef["type"]): OperatorDef[] =>
  type === "number" ? NUMBER_OPERATORS : STRING_OPERATORS;

export type FilterRuleRow = {
  id: string;
  field: string;
  operator: string;
  value: string;
