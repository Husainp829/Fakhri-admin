      ...
      .then(({ json }) => {
        if (!cancelled && json) {
          setFilterOpts({
            ...
            subSectors: Array.isArray(json.subSectors) ? json.subSectors : [],
            idaras: Array.isArray(json.idaras) ? json.idaras : [],
            organisations: Array.isArray(json.organisations) ? json.organisations : [],
          });
        }
      })
      .catch(() => {
